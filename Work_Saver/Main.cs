...
public class Main : MonoBehaviour {  
	...
	private Vector3 v1 = new Vector3(0.0f,3.0f,0.0f);  
	private Vector3 v2 = new Vector3(3.0f,3.0f,0.0f);  
	private Vector3 v3 = new Vector3(3.0f,0.0f,0.0f);  
	...
	void OnGUI()
	{
		GUIUtility.ScaleAroundPivot (new Vector2(0.5, 0.5), new Vector2(328.0, 328.0));
	}
